...
class SampleHandler: RPBroadcastSampleHandler {
    ...
    override func broadcastPaused() {
        ...
        os_log(.debug, log: broadcastLogger, "broadcastPaused", socketFilePath)
    }
    
    override func broadcastResumed() {
        os_log(.debug, log: broadcastLogger, "broadcastResumed", socketFilePath)
