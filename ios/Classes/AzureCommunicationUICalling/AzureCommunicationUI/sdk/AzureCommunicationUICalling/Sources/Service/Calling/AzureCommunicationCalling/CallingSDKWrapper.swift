...
//            try await call.startVideo(stream: videoStream)
    ...
    private func captureOutput(sampleBuffer: CMSampleBuffer, sampleBufferType: RPSampleBufferType, error: Error?) {
        ...
        let format = localScreenShareOutgoingVideoStream?.format
