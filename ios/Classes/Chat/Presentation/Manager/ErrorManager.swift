...
protocol ChatErrorManagerProtocol {
}

class ErrorManager: ChatErrorManagerProtocol {
    ...
    private func updateEventHandler(_ errorState: ChatErrorState) {
    ...
    private func updateFatalError(_ errorState: ChatErrorState) {
    ...
    private func getChatCompositeError(errorState: ChatErrorState) -> ChatCompositeError? {
        guard let internalError = errorState.internalError,
