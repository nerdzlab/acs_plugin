...
public class ChatCompositeViewController: UIViewController {
    var chatView: UIHostingController<ChatContainerView>!
    ...
    func makeContainerUIHostingController(viewFactory: ChatCompositeViewFactoryProtocol,
                                          canDismiss: Bool) -> ChatContainerUIHostingController {
        let rootView = ChatContainerView(viewFactory: viewFactory)
        let containerUIHostingController = ChatContainerUIHostingController(rootView: rootView)
