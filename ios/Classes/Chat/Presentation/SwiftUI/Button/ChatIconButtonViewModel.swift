...
class ChatIconButtonViewModel: ObservableObject {
    enum ButtonType {
        case controlButton
        case sendButton
    }

    @Published var iconName: ChatCompositeIcon
    ...
    init(iconName: ChatCompositeIcon,
    ...
    func update(iconName: ChatCompositeIcon?) {
