...
protocol ChatBaseLocalizationProviderProtocol {
    var isRightToLeft: Bool { get }
    func apply(localeConfig: ChatLocalizationOptions)
...
class ChatBaseLocalizationProvider: ChatBaseLocalizationProviderProtocol {
