...
protocol ChatActionHandling {
    ...
    @discardableResult
    func enterBackground(state: ChatAppState, dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func enterForeground(state: ChatAppState, dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>

    // MARK: ChatActionHandler
    @discardableResult
    func onChatThreadDeleted(dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func disconnectChat(dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    ...
    @discardableResult
    func getInitialMessages(state: ChatAppState, dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func getListOfParticipants(state: ChatAppState, dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func getPreviousMessages(state: ChatAppState, dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    ...
    func deleteMessage(messageId: String,
                       ...
                       dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func sendTypingIndicator(state: ChatAppState, dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func sendReadReceipt(messageId: String, state: ChatAppState, dispatch: @escaping ChatActionDispatch)
    -> Task<Void, Never>
    func setTypingParticipantTimer(_ getState: @escaping () -> ChatAppState, _ dispatch: @escaping ChatActionDispatch)
}
...
class ChatActionHandler: ChatActionHandling {
    ...
    private func sendReadReceiptToChatService(messageId: String, dispatch: @escaping ChatActionDispatch) async {
        do {
