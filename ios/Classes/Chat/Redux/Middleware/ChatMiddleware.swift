...
extension Middleware where State == ChatAppState {
    ...
    private static func handleLifecycleAction(_ action: ChatLifecycleAction,
    ...
    private static func handleRepositoryAction(_ action: ChatRepositoryAction,
                                               _ actionHandler: ChatActionHandling,
                                               _ getState: () -> State,
                                               _ dispatch: @escaping ChatActionDispatch) {
        switch action {
