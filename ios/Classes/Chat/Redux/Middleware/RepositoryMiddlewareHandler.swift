...
protocol RepositoryMiddlewareHandling {
    ...
    func addTopicUpdatedMessage(
        ...
        dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func participantAddedMessage(participants: [ChatParticipantInfoModel],
                                 state: ChatAppState,
                                 dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
    func participantRemovedMessage(participants: [ChatParticipantInfoModel],
                                   dispatch: @escaping ChatActionDispatch) -> Task<Void, Never>
    @discardableResult
...
class RepositoryMiddlewareHandler: RepositoryMiddlewareHandling {
    ...
    private func filterOutMaskedParticipantsFromMessage(
        ...
        state: ChatAppState) -> [ChatParticipantInfoModel] {
