...
enum ParticipantsAction: Equatable {
    ...
    case fetchListOfParticipantsSuccess(participants: [ChatParticipantInfoModel], localParticipantId: String?)
    ...
    case participantsAdded(participants: [ChatParticipantInfoModel])
    case participantsRemoved(participants: [ChatParticipantInfoModel])
