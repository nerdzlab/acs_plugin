...
extension Reducer where State == ChatNavigationState,
                        Actions == ActionChat {
    static var chatLiveNavigationReducer: Self = Reducer { state, action in
        ...
        return ChatNavigationState(status: navigationStatus)
    }
}
