...
extension Reducer where State == ChatParticipantsState,
                        Actions == ActionChat {
    static var liveParticipantsReducer: Self = Reducer { participantsState, action in
        ...
        case .participantsAction(.fetchListOfParticipantsSuccess(let participants, let localParticipantId)):
            var newParticipants: [String: ChatParticipantInfoModel] = [:]
        ...
        return ChatParticipantsState(participants: currentParticipants,
